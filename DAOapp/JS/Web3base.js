...
const TreasuryAddress = "0xD4886C6757819D857D1795cF43368473BeAcFA70";
...
async function GetLatestProposal(){
    LatestProposal = await DAOcore.methods.MRIdentifier().call();
    OngoingProposalID = parseInt(LatestProposal).toString();
    OngoingProposal = [];
...
async function GetHENS(){
    ...
    if(window.location.pathname.includes('/profile')) {
        ...
        document.getElementById("address").innerHTML += "<br>Balance: " + balance + " CLD";
    }
}
