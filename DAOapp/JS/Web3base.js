...
async function LoadCurrentProposal(){
    ...
    OngoingProposal = await DAOcore.methods.Proposals(OngoingProposalID).call();

    OngoingProposal.push(await DAOcore.methods.GetProposalVotes(OngoingProposal[0]).call());
