...
async function GetVotedProposals(){
    ...
    for(let i = 0; i < VotedProposals.length; i++){
        ...
        //if the proposal is over, recaculate the reward by checking the IncentivePerVote on the 3rd array of the proposal info, and devide it by the votes locked , then multiply it by the users votes locked
            ProposalStatus = "Over";
            TimeLeft = "Over";
            IsOver = "flex";
        } else {
