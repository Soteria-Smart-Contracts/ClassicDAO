...
document.getElementById('changeDefaultLengthTitle').style.display = 'none';
document.getElementById('changeDefaultLengthInput').style.display = 'none';
...
document.getElementById('changeQuorumTitle').style.display = 'none';
document.getElementById('changeQuorumInput').style.display = 'none';
