...
async function GetVotedProposals(){
    ...
    for(let i = 0; i < VotedProposals.length; i++){
        ...
        Reward = parseFloat(parseFloat(web3.utils.fromWei(CurrentProposalInfo[2].CLDtoIncentive) / parseFloat(CurrentProposalInfo[2].VotesLocked) * VoterInfo.VotesLocked).toFixed(2);
