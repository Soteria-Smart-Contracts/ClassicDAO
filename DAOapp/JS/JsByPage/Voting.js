...
async function LoadVoterList() {
    ...
    document.getElementById("VoterList").appendChild(document.createElement("h1").innerHTML = "<h1 id="votebuttonstext" style="font-size: 30px; margin-top: 0px; margin-bottom: 0px; font-family: GTWalsheim, bold; color: #fff;">Voters</h1>");
