...
async function LoadDashboard() {
    ...
    document.getElementById("memo").innerText = (CurrentProposalInfo[1].Memo).split("//")[0];
    document.getElementById("description").innerText = (CurrentProposalInfo[1].Memo).split("//")[1];
