...
async function CheckApproveVotingCLDContitional(){
    ...
    let approved = parseInt(web3.utils.fromWei((web3.utils.fromWei(await CLDtoken.methods.allowance(account, VotingAddress).call(), 'ether'), 'ether') / 1000000000000000000000));
