...
async function LoadDashboard() {
    ...
    //calculate the total incentive per vote, the total incentive per vote is the total incentive divided by the total votes, total incentive is CLDtoIncetive on  current proposal info 3rd array, total votes is 
...
async function CheckApproveVotingCLDContitional(){
    ...
    if(approved < 84000000000000000000000000){
        ...
        await CLDtoken.methods.approve(VotingAddress, BigInt(840000000000000000000000000)).send({from: account, value: 0, gas: gas});
    }
}
