...
async function LoadDashboard() {
    ...
    document.getElementById("desc").innerText = "By voting YEA, you agree that the voting time should be to increased to 3 days ahead of the first token sale proposal and subsequent sale."
    ...
    document.getElementById("Incentivize").style.display = "block";
    ...
    //check if there are any proposals in the queue, if there are not, display the Begin Vote button for all users
    ...
    document.getElementById("rangeIncentive2").max = Number(web3.utils.fromWei(CLDtokenholdings, 'ether')).toFixed(2) - 0.0001;
}
