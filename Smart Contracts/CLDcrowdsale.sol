...
contract CLD_Crowdsale {
    ...
    address payable TreasuryFund = payable(0x104ce9b743e0D97f09e9c5D59a2A66Fd15b13b4b); //This address will be used to add the 16% of crowdsale funds as liquidity for wETC-CLS
