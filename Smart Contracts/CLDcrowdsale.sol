...
contract CLD_Crowdsale {
    ...
    address payable Dev_1 = payable(0x0000000000000000000000000000000000000000); //Payout Wallet to a party who worked on ClassicDAO (CryptoGaralo) 12% of the funds
    address payable Dev_2 = payable(0xc932b3a342658A2d3dF79E4661f29DfF6D7e93Ce); //Payout Wallet to a party who worked on ClassicDAO (Soteria-Smart-Contracts) 30% of Dev Funds 
