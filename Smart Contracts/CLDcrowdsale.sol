...
contract CLD_Crowdsale {
    ...
    address payable Dev_1 = payable(0x0000000000000000000000000000000000000000); //Payout Wallet to a party who worked on ClassicDAO (CryptoGaralo) 30% of Dev Funds
