...
contract CLD_Crowdsale {
    ...
    address payable TreasuryFund = payable(0xC61A70Fb5F8A967C71c1E9A42374FbE460D0a341); //This address will be used to add the 20% of crowdsale funds to the ClassicDAO Treasury
