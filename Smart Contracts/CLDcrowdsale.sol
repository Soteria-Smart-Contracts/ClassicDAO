...
contract CLD_Crowdsale {
    ...
    address payable TreasuryFund = payable(0xc932b3a342658A2d3dF79E4661f29DfF6D7e93Ce); //This address will be used to add the 35% of crowdsale funds as liquidity for wETC-CLD
