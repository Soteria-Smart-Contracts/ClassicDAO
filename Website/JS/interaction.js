...
const contractAddress = "0x2f3925fd3C8dbF2018F38E108066d75552d83689";
let account;
let balance;
let deposited;
let totaldeposited;
...
async function loginWithEth(){
    if(window.ethereum){
        ...
        await getID();
        if (netID != 3){
            console.log("The current Metamask/Web3 network is not Ropsten, please connect to the ETC network."); //CHANGE FOR REAL CROWDSALE TO ETC
            alert("The current Metamask/Web3 network is not Ethereum Classic, please connect to the Ropsten test network.");
            showOverlay();
