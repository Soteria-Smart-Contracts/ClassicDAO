...
async function UpdateDetails(){
    ...
    document.getElementById('CR2').innerText = (((document.getElementById('Two').value) / 100) * 102.5).toString();
    document.getElementById('CR3').innerText = (((document.getElementById('Three').value) / 100) * 102.5).toString();
